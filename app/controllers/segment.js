...
exports.getSegmentWithCommunes = function(req,res,next){
    ...
    Support.find({$or: [{'properties.id_commune':parseInt(id),cid: mongoose.Types.ObjectId(req.query.cid)}, {'id_commune':parseInt(id),cid: mongoose.Types.ObjectId(req.query.cid)}]})
